...
<div class="flex flex-col mt-10">
	<div class="flex justify-end px-5">
		<a href="<?php menu_page_url('add-property') ?>" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
	      Add New Property
	    </a>
	</div>
            ...
            <?php foreach($properties as $property):?>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                ...
                <form class="inline" method="POST">
                  ...
                  <button type="submit" class="text-red-600 hover:text-red-900" name="delete-property">Delete</button>
                </form>
              </td>
            </tr>
            <?php endforeach;?>
